...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$()
    {
        ...
        removeLocalButton = new JButton();
        removeLocalButton.setText("Remove local");
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 0;
        gbc.gridwidth = 2;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        viewTab.add(removeLocalButton, gbc);
        removeLocalButton1 = new JButton();
        removeLocalButton1.setText("Remove local");
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 1;
        gbc.gridwidth = 2;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        viewTab.add(removeLocalButton1, gbc);
        removeLocalButton2 = new JButton();
        removeLocalButton2.setText("Remove local");
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 2;
        gbc.gridwidth = 2;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        viewTab.add(removeLocalButton2, gbc);
        removeLocalButton3 = new JButton();
        removeLocalButton3.setText("Remove local");
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 3;
        gbc.gridwidth = 2;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        viewTab.add(removeLocalButton3, gbc);
        removeLocalButton4 = new JButton();
        removeLocalButton4.setText("Remove local");
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 4;
        gbc.gridwidth = 2;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        viewTab.add(removeLocalButton4, gbc);
